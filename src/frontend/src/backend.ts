...
export class Backend implements backendInterface {
    ...
    async sendMessage(arg0: MessageInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(to_candid_MessageInput_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_FamilyMember_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FamilyMember): FamilyMember {
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FamilyMember]): FamilyMember | null {
    return value.length === 0 ? null : from_candid_FamilyMember_n6(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        familyMember: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.familyMember))
    };
}
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "nik" in value ? FamilyMember.nik : "mariana" in value ? FamilyMember.mariana : "marina" in value ? FamilyMember.marina : value;
}
...
function to_candid_FamilyMember_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FamilyMember): _FamilyMember {
    return to_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function to_candid_MessageInput_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageInput): _MessageInput {
...
function to_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        familyMember: value.familyMember ? candid_some(to_candid_FamilyMember_n16(_uploadFile, _downloadFile, value.familyMember)) : candid_none()
    };
}
function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        content: value.content,
        sender: to_candid_FamilyMember_n16(_uploadFile, _downloadFile, value.sender)
    };
}
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FamilyMember): {
    nik: null;
} | {
    mariana: null;
} | {
    ...
    return value == FamilyMember.nik ? {
        nik: null
    } : value == FamilyMember.mariana ? {
        mariana: null
    } : value == FamilyMember.marina ? {
        marina: null
    } : value;
}
